...
import type { Color, Indicator, Size } from "../types/types";
...
const variant = ["list", "card"] as const;
const indicator: Indicator[] = ["start", "end", "hidden"] as const;
...
export const checkbox = tv({
  slots: {
    ...
    indicator:
      "flex items-center justify-center size-full text-inverted" as (typeof indicator)[number],
...
export type CheckboxSlots = ComponentSlots<typeof checkbox>;
