...
import * as ToggleGroupPrimitive from "./toggle-group";
import { createToggleGroupScope } from "./toggle-group";
...
type ToolbarSeparatorElement = React.ComponentRef<
...
type ToolbarToggleGroupElement = React.ComponentRef<
...
type ToolbarToggleItemElement = React.ComponentRef<
