...
const [createPasswordToggleFieldContext] = createContextScope(
  PASSWORD_TOGGLE_FIELD_NAME
);
const [PasswordToggleFieldProvider, usePasswordToggleFieldContext] =
  createPasswordToggleFieldContext<PasswordToggleFieldContextValue>(
    PASSWORD_TOGGLE_FIELD_NAME
  );
...
const PasswordToggleField: React.FC<PasswordToggleFieldProps> = ({
  ...
  const [inputIdState, setInputIdState] = React.useState<null | string>(
    defaultInputId
  );
...
>(
  (
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React.useState<
      string | undefined
    >(undefined);
